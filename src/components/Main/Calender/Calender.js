...
const Calender = ( props ) => {
  ...
  return (
    <div className='events'>
      ...
      <div className='d-flex' onClick={()=>setShowFunctionality('createNewEvent')}>
        <div className="plus">+</div>
        <p>Create New event</p>
      </div>
      <div className='d-flex' onClick={()=>setShowFunctionality('activeEvents')}>
        <div className="circle" style={{ backgroundColor: "#D78F24" }}></div>
        <p>Active events</p>
      </div>
      <div className='d-flex' onClick={()=>setShowFunctionality('oldEvents')}>
        <div className="circle" style={{ backgroundColor: "#AE3F9B" }}></div>
        <p>Old events</p>
      </div>
      <div className='d-flex' onClick={()=>setShowFunctionality('draftEvents')}>
